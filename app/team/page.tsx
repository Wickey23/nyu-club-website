...
export default async function TeamPage(){
  ...
  const board=(site.settings.cmsConfig?.board||{}) as {currentYear?:string;showEmails?:boolean;showBios?:boolean;hideEmptyYears?:boolean};
